...
class _RestClient implements RestClient {
  ...
  @override
  Future<WikiListResponse> getWikiTopList(int lang, String platform) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'lang': lang,
      r'PLATFORM': platform,
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<WikiListResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/wiki/topList',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late WikiListResponse _value;
    try {
      _value = WikiListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<WikiDetailResponse> getWikiDetail(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<WikiDetailResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/version/detail',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late WikiDetailResponse _value;
    try {
      _value = WikiDetailResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
